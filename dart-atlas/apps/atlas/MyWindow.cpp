...
void MyWindow::initDyn()
{
    ...
    for (unsigned int i = 0; i < mSkels.size(); i++) {
        ...
        cout << "Setting: " << mSkels[i]->getName() << endl;
        cout << mDofs[i].transpose() << endl;
    ...
    cout << mSkels[0]->getName() << endl;
    cout << mSkels[0]->getPose().transpose() << endl;
}
...
void MyWindow::draw()
{
    ...
    atlas::AtlasRenderer ar;
    ar.drawSkeleton(mSkels[1], mRI);
